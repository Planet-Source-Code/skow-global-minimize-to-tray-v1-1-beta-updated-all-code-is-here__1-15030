...
Sub SendToTray(vbForm As Form, hWND As Long, TrayCaption As String, HideHWND As Boolean, HideForm As Boolean, IconH As Long)
    ...
    Dim xTray As NOTIFYICONDATA_5
           ...
           With xTray
                ...
                .szInfoTitle = "To Un-hide this program, click here:" & vbNullChar
...
Public Function IsV5Compat() As Boolean
...
Function GetLen() As Long
    If IsV5Compat Then
        Dim X As Tray.NOTIFYICONDATA_5
        GetLen = Len(X)
    Else
        Dim Y As Tray.NOTIFYICONDATA
        GetLen = Len(Y)
    End If
End Function
